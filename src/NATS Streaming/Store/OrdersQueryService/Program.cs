...
namespace Store.QueryService
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            _eventsMessageBroker.StartDurableMessageConsumer("store.events", EventReceived, "readmodel");
            ...
            Console.Clear();
            Console.WriteLine("ReadModel consumers ready.");
        ...
        private static void EventReceived(string messageType, string messageData)
        {
            try
            {
        ...
        {
            return typeof(Store.QueryService.Program).GetMethod(messageType, BindingFlags.NonPublic | BindingFlags.Static);
        }
